...
# file output
prefix = "sin_relaxation_channel_nh"
prefix = "sin_relaxation_channel_nh_qt"
...
@inline wind_shape(y, p) = sin(π * y / p.Ly) # exp( -(y - p.Ly/2)^2 / (p.Ly^2 / p.λᵘ) ) - exp( -( p.Ly/2)^2 / (p.Ly^2 / p.λᵘ) ) 
