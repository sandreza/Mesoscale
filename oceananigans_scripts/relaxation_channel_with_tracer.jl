...
tracer_case_k = 32
# file output
prefix = "relaxation_channel_tracers_restarted_"* "smooth_forcing" * "_j"* string(tracer_case_j) * "_k" * string(tracer_case_k)
...
parameters = (
    ...
    tracer_case_j = tracer_case_j,
    tracer_case_k = tracer_case_k,
)
